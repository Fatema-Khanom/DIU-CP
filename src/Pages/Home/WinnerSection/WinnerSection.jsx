...
const WinnerSection = () => {
  ...
  return (
    <div className="">
        <h2 data-aos="fade-up"
     data-aos-anchor-placement="center-center" className= "text-center text-[#dee5e5] opacity-1 items-center relative font-bold mb-4 pt-16 text-6xl lg:text-9xl">
          WINNERS
        </h2>
       <div className="">
       <h2 data-aos="fade-up"
     data-aos-anchor-placement="center-center" className= "text-center text-blue-600 items-center -mt-16 pb-4 lg:-mt-24 text-3xl lg:text-4xl font-bold relative">
      ...
      data-aos-easing="ease-out-cubic"
      data-aos-duration="2000"
      className={`md:w-1/2 px-8 h-[400px] overflow-y-auto borde border-gray-300 p-4 mb-4 ${isExpanded ? 'h-auto' : ''}`}>
