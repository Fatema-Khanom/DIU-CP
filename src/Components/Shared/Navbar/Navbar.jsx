...
const Navbar = () => {
  ...
  return (
    ...
    <div className="fixed top-0 left-0 fixed top-0 left-0 w-full text-white lg:px-1  z-10 ">
      {/* Navbar Content */}
      <div className="navbar bg-base-300 drop-shadow lg:px-20 py- lg:rounded-full">
        {/* Navbar Start */}
        <div className="flex justify-between  lg:navbar-start">
          ...
          <div className="dropdown justify-between  lg:hidden flex items-center">
            ...
            <div tabIndex={0} role="button" className="btn btn-ghost text-right lg:hidden">
              <svg xmlns="http://www.w3.org/2000/svg" className=" h-5 w-5 font-bold text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
